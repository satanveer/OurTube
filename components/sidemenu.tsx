...
export default function SideMenu() {
    const menuItems = [
        ...
        {'name': 'Technology', 'icon': '/images/education.png', 'ln': '#'},
        {'name': 'Education', 'icon': '/images/education.png', 'ln': '#'},
        {'name': 'Fashion', 'icon': '/images/fashion.png', 'ln': '#'},
        {'name': 'Health', 'icon': '/images/clock.png', 'ln': '#'},
        {'name': 'Travel', 'icon': '/images/clock.png', 'ln': '#'},
        {'name': 'Food', 'icon': '/images/clock.png', 'ln': '#'},
        {'name': 'Comedy', 'icon': '/images/social.png', 'ln': '#'},
